...
Код лежит на машине разработки, а работает на трёх других, и до выкатки правка не
...
Своей выкатки у `ccfzf` нет — он живёт на машине разработки и читается по ssh. Проверить,
