  ...
  function buildProjectList({ projects } = {}) {
    ...
    return list
      ...
      .map(p => ({
        ...
        // Счётчики docs/TODO.md. Ключа в ответе нет у половины проектов —
        // агрегатор ставит его только непустым, — и пустой массив здесь
        // значит ровно то же: считать нечего, колонки не будет. Разбор
        // содержимого секций живёт у отрисовщика (todoHtml в
