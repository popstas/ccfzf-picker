...
(function (root, factory) {
  ...
  // Состояние агента внутри окна приходит из window-tracker (claude-wt),
  ...
  function rowTitle(session) {
    ...
    // window-tracker (`agentDescription`), и ту же строку видят Home Assistant
  ...
  // так проверена на форму в window-tracker, и второе поле означало бы два
