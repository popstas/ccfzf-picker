  ...
  function buildZellijList({ zellij } = {}) {
    ...
    return list
      ...
      .map(z => ({
        ...
        cwd: '',
        // Метка источника: слияние в Rust ставит её на каждую строку списка,
        // и `attach` в open-strategy.js обязан пойти на ту же машину, где эта
        // зелийная сессия и живёт, а не на CONFIG.sshHost по умолчанию.
