...
// в пикселях там видны и имена машин подзаголовками чужих сессий, и путь
// `/home/popstas/...`, то есть ровно те строки, которые остальным файлам этот
...
// лишь называет цену вслух. Второму снимку тут появляться не следует, не
// замазав на нём имена.
