...
// `/home/user` без якорения и ловит его в любом положении внутри строки,
// в том числе в форме `backup2024/home/user` — но только на той машине,
// где этот файл есть; у всех остальных, кто склонирует репозиторий, эта
// форма останется непойманной.
const UNIVERSAL = [
